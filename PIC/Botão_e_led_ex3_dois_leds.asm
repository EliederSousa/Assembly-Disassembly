...
#DEFINE BOTAO2	PORTA,3 ;O NOVO BOTÃO
			; 0 -> PRESSIONADO
			; 1 -> LIBERADO
...
#DEFINE LED2 PORTB, 1; O NOVO LED
			; 0 -> APAGADO
			; 1 -> ACESO
...
INICIO
	...
	MOVLW	B'00001100'
	MOVWF	TRISA		;DEFINE RA2 e RA3 COMO ENTRADAS E DEMAIS
				;COMO SAÍDAS
	MOVLW	B'00000000'
...
LEBOTAO2
	BTFSC	BOTAO2		;O BOTÃO2 ESTÁ PRESSIONADO?
	GOTO	BOTAO2_LIB	;NÃO, ENTÃO TRATA BOTÃO2 LIBERADO
	GOTO	BOTAO2_PRES	;SIM, ENTÃO TRATA BOTÃO2 PRESSIONADO

BOTAO_LIB
	BCF	LED				;APAGA O LED1
	GOTO 	LEBOTAO2	;RETORNA AO LOOP PRINCIPAL

BOTAO_PRES
	BSF	LED				;ACENDE O LED1
	GOTO 	LEBOTAO2	;RETORNA AO LOOP PRINCIPAL
